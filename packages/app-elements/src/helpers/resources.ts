...
const singularLowercase: Record<ListableResourceType, string> = {
  ...
  orders: "order",
  packages: "package",
  payment_authorizations: "payment authorization",
  payment_captures: "payment capture",
  payment_links: "payment link",
  payment_refunds: "payment refund",
  payment_rules: "payment rule",
  payment_sessions: "payment session",
  payment_setting_adyens: "payment setting adyen",
  payment_setting_braintrees: "payment setting braintree",
  payment_setting_checkout_coms: "payment setting checkout.com",
  payment_setting_externals: "payment setting external",
  payment_setting_gift_cards: "payment setting gift card",
  payment_setting_manuals: "payment setting manual",
  payment_setting_paypals: "payment setting paypal",
  payment_setting_stripes: "payment setting stripe",
  payment_settings: "payment setting",
  payment_transactions: "payment transaction",
  payment_voids: "payment void",
  payment_wallets: "payment wallet",
...
const pluralLowercase: Record<ListableResourceType, string> = {
  ...
  payment_setting_adyens: "payment setting adyens",
  payment_setting_braintrees: "payment setting braintrees",
  payment_setting_checkout_coms: "payment setting checkout.coms",
  payment_setting_externals: "payment setting externals",
  payment_setting_gift_cards: "payment setting gift cards",
  payment_setting_manuals: "payment setting manuals",
  payment_setting_paypals: "payment setting paypals",
  payment_setting_stripes: "payment setting stripes",
  payment_settings: "payment settings",
  payment_transactions: "payment transactions",
  payment_voids: "payment voids",
