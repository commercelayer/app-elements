...
const singularLowercase: Record<ListableResourceType, string> = {
  ...
  returns: "return",
  rules_tax_calculators: "rules tax calculator",
  tax_business_rules: "tax business rule",
...
const pluralLowercase: Record<ListableResourceType, string> = {
  ...
  returns: "returns",
  rules_tax_calculators: "rules tax calculators",
  tax_business_rules: "tax business rules",
