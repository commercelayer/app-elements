      ...
      <div>
        ...
        >
          <button
            aria-expanded="false"
            aria-haspopup="true"
            class="font-medium whitespace-nowrap leading-5 inline-flex items-center gap-1 justify-center transition-opacity duration-500 button h-10 min-w-10 text-[15px] px-4 rounded bg-black border border-black text-white hover:opacity-80"
          >
            Open dropdown
          </button>
        </div>
