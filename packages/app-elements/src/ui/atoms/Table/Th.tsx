...
function Th({ children, className, ...rest }: ThProps): JSX.Element {
  return (
    <th
      className={cn(
        className,
        "p-4 text-2xs leading-4 font-medium uppercase border-b border-gray-100 bg-gray-50 text-gray-500 text-nowrap first-of-type:rounded-ss last-of-type:rounded-se",
        {
