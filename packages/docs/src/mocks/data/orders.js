          ...
          relationships: {
            ...
            tags: {
              links: {
                ...
                related: 'https://mock.localhost/api/customers/JkAdBhNGjQ/tags'
              }
            }
          },
          meta: { mode: 'test', organization_id: 'WXlEOFrjnr' }
          ...
          relationships: {
            ...
            item: {
              links: {
                ...
                related: 'https://mock.localhost/api/line_items/vaoMtAZlXy/item'
              }
            },
            line_item_options: {
              links: {
            ...
            tags: {
              links: {
                ...
                related: 'https://mock.localhost/api/line_items/vaoMtAZlXy/tags'
              }
            }
          },
          meta: { mode: 'test', organization_id: 'WXlEOFrjnr' }
          ...
          relationships: {
            ...
            item: {
              links: {
                ...
                related: 'https://mock.localhost/api/line_items/kmnptjPlBv/item'
              }
            },
            line_item_options: {
              links: {
            ...
            tags: {
              links: {
                ...
                related: 'https://mock.localhost/api/line_items/kmnptjPlBv/tags'
              }
            }
          },
          meta: { mode: 'test', organization_id: 'WXlEOFrjnr' }
          ...
          relationships: {
            ...
            item: {
              links: {
                ...
                related: 'https://mock.localhost/api/line_items/vWEZtMGVKy/item'
              }
            },
            line_item_options: {
              links: {
            ...
            tags: {
              links: {
                ...
                related: 'https://mock.localhost/api/line_items/vWEZtMGVKy/tags'
              }
            }
          },
          meta: { mode: 'test', organization_id: 'WXlEOFrjnr' }
          ...
          relationships: {
            ...
            item: {
              links: {
                ...
                related: 'https://mock.localhost/api/line_items/NqYatGaKnN/item'
              }
            },
            line_item_options: {
              links: {
            ...
            tags: {
              links: {
                ...
                related: 'https://mock.localhost/api/line_items/NqYatGaKnN/tags'
              }
            }
          },
          meta: { mode: 'test', organization_id: 'WXlEOFrjnr' }
          ...
          relationships: {
            ...
            item: {
              links: {
                ...
                related: 'https://mock.localhost/api/line_items/NoEntBwEdk/item'
              }
            },
            line_item_options: {
              links: {
            ...
            tags: {
              links: {
                ...
                related: 'https://mock.localhost/api/line_items/NoEntBwEdk/tags'
              }
            }
          },
          meta: { mode: 'test', organization_id: 'WXlEOFrjnr' }
          ...
          relationships: {
            ...
            item: {
              links: {
                ...
                related: 'https://mock.localhost/api/line_items/NlQmtMAnGy/item'
              }
            },
            line_item_options: {
              links: {
            ...
            tags: {
              links: {
                ...
                related: 'https://mock.localhost/api/line_items/NlQmtMAnGy/tags'
              }
            }
          },
          meta: { mode: 'test', organization_id: 'WXlEOFrjnr' }
          ...
          relationships: {
            order: {
              links: {
                ...
                related: 'https://mock.localhost/api/shipments/YpLwCnNQgY/order'
              }
            },
            shipping_category: {
              links: {
          ...
          relationships: {
            order: {
              links: {
                ...
                related: 'https://mock.localhost/api/shipments/PabvCpOxRy/order'
              }
            },
            shipping_category: {
              links: {
          ...
          relationships: {
            order: {
              links: {
                ...
                related: 'https://mock.localhost/api/captures/kyAnxUgegE/order'
              }
            },
            attachments: {
              links: {
...
const orderUpdate = http.patch(
  ...
  async ({ request }) => {
    ...
    if (![null, '10PER100'].includes(data.attributes.coupon_code)) {
      await delay(1000)
      return HttpResponse.json(
        {
          errors: [
            {
              title: "doesn't exist",
              detail: "coupon_code - doesn't exist",
              code: 'VALIDATION_ERROR',
              source: {
                pointer: '/data/attributes/coupon_code'
              },
              status: '422',
              meta: {
                error: 'noent_coupon'
...
export default [orderDetail, orderList, orderNotFound, orderUpdate]
