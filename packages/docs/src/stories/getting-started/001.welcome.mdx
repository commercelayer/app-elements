...
This library is served as [npm package](https://www.npmjs.com/package/@commercelayer/app-elements) and need to be installed as dependency inside your project.
