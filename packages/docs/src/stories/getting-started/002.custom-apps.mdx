...
<img src="dashboard-custom-apps.jpeg" className='rounded' style={{ marginBottom: '24px' }} />
...
Watch the instructional video below to learn more: it goes through the whole process of hosting your custom app on Vercel and making it available on the Dashboard.

<div class="embed-responsive">
  <iframe width="560" height="315" src="https://www.youtube.com/embed/8dEvt7B-Vrk?si=ptcsBrVdlFrCKZI-" title="Introducing Commerce Layer's Custom Apps" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
